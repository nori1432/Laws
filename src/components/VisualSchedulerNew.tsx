...
import { Clock, Users, Calendar, GripVertical, Plus, X, Edit3 } from 'lucide-react';
    ...
    <div className="bg-card rounded-lg border border-border p-6">
      ...
      <DragDropContext onDragEnd={handleDragEnd}>
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          <h4 className="text-sm font-medium text-foreground mb-3">Section Duration Settings</h4>
              ...
              >
                    ...
                    >
                      {(provided, snapshot) => (
                        ...
                        >
                          ...
                          <span className="text-xs bg-muted-foreground/20 px-2 py-1 rounded text-center block mt-2">
                            Drag to schedule
                          </span>
                        </div>
                      )}
                ...
                {unscheduledSections.length === 0 && (
                  <div className="text-center py-6 text-muted-foreground">
                    ...
                    <p className="text-sm">All sections are scheduled!</p>
                  </div>
                )}
                {provided.placeholder}
              </div>
